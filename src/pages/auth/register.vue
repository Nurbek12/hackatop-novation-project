<template>
    <!-- <form action=""> -->
    <h1 class="nunito-extra-bold text-3xl mb-8">Sign up with <br> Number</h1>
    <app-input required v-model="auth_data.phone_number" label="Write your number" variant="outlined" placeholder="+998" v-mask="'+### ## ### ## ##'" />
